...
internal class ScrollFlingDetector(
    ...
    override fun onFling(p0: MotionEvent, p1: MotionEvent, p2: Float, p3: Float): Boolean {
        ...
        val velX = (if (panManager.horizontalPanEnabled) p2 else 0F).toInt()
        val velY = (if (panManager.verticalPanEnabled) p3 else 0F).toInt()
...
*/
     ...
     */
    /*
    override fun onScroll(p0: MotionEvent, p1: MotionEvent, @ZoomApi.ScaledPan p2: Float, @ZoomApi.ScaledPan p3: Float): Boolean {
